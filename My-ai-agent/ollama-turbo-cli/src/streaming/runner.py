    ...
    try:
        while True:
            ...
            try:
                ...
                if (not tools_used_stream) and ctx.reliability.get('consensus') and isinstance(ctx.reliability.get('consensus_k'), int) and (ctx.reliability.get('consensus_k') or 0) > 1:
                    def _gen_once_stream():
                        ...
                        # Mirror standard path: request-level reasoning injection
                        try:
